...
const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || 'https://testdrivefirst.com';
  ...
  return (
    <html lang='en' className={jakarta.variable}>
      ...
      <body className={`${jakarta.className} antialiased`}>
        ...
        {/* <Script id="supportflow-config" strategy="afterInteractive">
          {`
          window.SupportFlowConfig = {
            apiKey: "sf_e76af2b2e8df4fad9e62e2057fdef870",
            baseUrl: "https://saasbot.evradar.in",
          };
        `}
        </Script>

        <Script
          src="https://saasbot.evradar.in/widget.js"
