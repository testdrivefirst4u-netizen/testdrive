    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <VehicleForm
        vehicle={{
          ...
          variants: vehicle.variants.map(v => ({ ...v, priceDisplay: v.priceDisplay || undefined, fuelType: v.fuelType || undefined, transmission: v.transmission || undefined, mileage: v.mileage || undefined, range: v.range || undefined })),
          images: vehicle.images.map(i => ({ ...i, fileId: i.fileId || undefined, type: i.type || "gallery" })),
          colours: vehicle.colours.map(c => ({ ...c, hexCode: c.hexCode || undefined, imageUrl: c.imageUrl || undefined })),
        }}
        brands={brands}
