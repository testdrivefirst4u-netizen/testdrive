...
export function VehicleDetailPage({ vehicle, similar, vehicleType }: Props) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
              <div className="relative h-64 sm:h-80 md:h-[400px] bg-slate-50">
                ...
                {/* Share */}
                <button className="absolute top-3 right-3 w-8 h-8 bg-white/80 hover:bg-white rounded-full flex items-center justify-center transition-colors shadow-sm">
      ...
      <OfferPopup isOpen={offerOpen} onClose={() => setOfferOpen(false)} carName={vehicle.name} />
    </div>
  );
}
