  ...
  featured: [
    {
      icon: Flame,
      label: 'Popular Cars',
      sub: 'Best-selling models',
      href: '/cars?sort=popularity',
      hot: true,
    },
    {
      icon: TrendingUp,
      label: 'New Launches',
      sub: 'Latest 2025–26 models',
      href: '/new-car-launches',
    },
    {
      icon: Clock,
      label: 'Upcoming Cars',
      sub: 'Coming soon this year',
      href: '/cars?upcoming=true',
    },
    {
      icon: PlugZap,
      label: 'Electric Cars',
      sub: 'Zero-emission vehicles',
      href: '/ev',
    },
  ],
  types: [
...
const MORE_ITEMS = [
  {
    ...
    sub: 'Plan your car loan',
    href: '/emi-calculator',
  },
  {
    icon: Shield,
    label: 'Car Insurance',
    sub: 'Compare & save on premium',
    href: '/insurance',
  },
  {
    icon: MapPin,
    label: 'Find Dealers',
    sub: 'Authorised near you',
    href: '/dealers',
  },
  {
    icon: Star,
    label: 'Expert Reviews',
    sub: 'In-depth road tests',
    href: '/reviews',
  },
  {
    icon: Newspaper,
    label: 'Auto News',
    sub: 'Latest auto updates',
    href: '/news',
  },
  {
    icon: Headphones,
            ...
            <nav className='hidden lg:flex items-center gap-0.5 ml-2 flex-1'>
              ...
              <div className='relative'>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform duration-200 ${openMenu === 'cars' ? 'rotate-180' : ''}`}
                  />
                </button>
              ...
              <div className='relative'>
                ...
                >
                  More
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform duration-200 ${openMenu === 'more' ? 'rotate-180' : ''}`}
                  />
                </button>
            ...
            <nav className='flex-1 overflow-y-auto py-3 px-3 no-scrollbar'>
              ...
              {MOBILE_NAV.map((link) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-xl ${link.bg} flex items-center justify-center shrink-0`}
                    >
                      <Icon className={`w-4 h-4 ${link.accent}`} />
                    </div>
                    <span
                      className={`text-sm font-semibold flex-1 ${active ? 'text-blue-700' : 'text-slate-700 group-hover:text-blue-700'} transition-colors`}
                    >
                      {link.label}
                    </span>
