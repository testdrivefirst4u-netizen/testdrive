...
const SOCIALS = [
  {
    icon: Facebook,
    href: 'https://facebook.com/testdrivefirst',
    label: 'Facebook',
    bg: 'hover:bg-[#1877f2]',
  },
  {
    icon: Twitter,
    href: 'https://x.com/testdrivefirst',
    label: 'X (Twitter)',
    bg: 'hover:bg-[#0f1419]',
  },
  {
    icon: Instagram,
    href: 'https://instagram.com/testdrivefirst',
    label: 'Instagram',
    bg: 'hover:bg-gradient-to-br hover:from-[#f58529] hover:via-[#dd2a7b] hover:to-[#515bd4]',
  },
  {
    icon: Youtube,
    href: 'https://youtube.com/@testdrivefirst',
    label: 'YouTube',
    bg: 'hover:bg-[#ff0000]',
  },
];
        ...
        <div className='max-w-[1400px] mx-auto px-4 sm:px-6 py-7'>
          <div className='flex flex-col md:flex-row md:items-center justify-between gap-5'>
            ...
            <div className='flex items-center'>
              <Link href='/'>
                <Image
                  ...
                  width={500}
                  height={120}
                  className='h-14 sm:h-20 lg:h-24 w-auto object-contain brightness-0 invert'
                  priority
                />
              </Link>
            </div>
            ...
            <div className='flex items-center gap-2'>
              <span className='text-xs text-slate-500 mr-1 hidden sm:block'>
                Follow us
              </span>
              {SOCIALS.map((s) => {
                const Icon = s.icon;
            ...
            <div className='flex flex-wrap gap-2'>
              ...
              <a
                href='mailto:support@testdrivefirst.com'
                className='flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl px-3.5 py-2 text-sm transition-all'
              >
                <Mail className='w-3.5 h-3.5 text-blue-400' />
                <span className='text-slate-200 text-xs'>
                  support@testdrivefirst.com
                </span>
              </a>
            </div>
          </div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
          ...
          <div>
            ...
            <ul className='space-y-2.5 mb-6'>
              {[
                { label: 'About TestDriveFirst', href: '/about' },
            ...
            <div className='flex items-center gap-2.5 bg-white/5 border border-white/10 rounded-xl p-3'>
              ...
              <div>
                ...
                <p className='text-[10px] text-slate-400 mt-0.5'>
                  Verified dealers · Certified vehicles
                </p>
              </div>
            </div>
          </div>
      ...
      <div className='border-t border-white/5'>
        <div className='max-w-[1400px] mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3'>
          <p className='text-xs text-slate-500 text-center sm:text-left'>
            © 2026 TestDriveFirst · All rights reserved
          </p>
